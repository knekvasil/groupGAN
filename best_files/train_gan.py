...
NUM_EPOCHS = 100
LATENT_DIM = 200
G_LEARNING_RATE = 0.0004 # Generator's learning rate
...
def train_gan(
    ...
    g_optimizer = optim.Adam(generator.parameters(), lr=g_lr, betas=(beta1, 0.9))
    d_optimizer = optim.Adam(discriminator.parameters(), lr=d_lr, betas=(beta1, 0.9))
